<script lang="ts">
	...
	export default {
		...
		setup() {
			...
			const addToHistory = (entry: TipCalculation) => store.commit("addToHistory", entry);
			...
			watch(
				...
				(query) => {
					...
					const { subtotal: querySubtotal, country: queryCountry }: TipCalculation =
						entry;
					...
					<ion-list>
						<ion-item>
							...
							<ion-input
								...
								v-model="subtotal"
								required
								placeholder="Subtotal"></ion-input>
						</ion-item>
